...
"""
    ...
    parameters {
        string(name: 'IMAGE_NAME', defaultValue: 'koroliuk/express-fe', description: 'Your image name in format USER_NAME/IMAGE. You can write it as default value if you want')
    }
